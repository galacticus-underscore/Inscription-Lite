...
move .\src\static\styles\sass\components\*.css .\src\static\styles\css\components >nul
...
move .\src\static\styles\sass\components\*.map .\src\static\styles\maps\components >nul
